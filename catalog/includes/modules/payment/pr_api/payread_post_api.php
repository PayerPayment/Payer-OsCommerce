 ...
 *
 $Id: payread_post_api.php,v 1.1 2015/04/22 11:57:44 bihla Exp $
 $Log: payread_post_api.php,v $
 Revision 1.1  2015/04/22 11:57:44  bihla
 rebuild of startpaket - COMPLETELY NEW STRUCTURE

 Revision 1.1  2015/04/22 11:16:25  bihla
 sharing startpaketINIT for the first time

 Revision 1.2  2015/04/22 08:17:23  maker
 *** empty log message ***

 Revision 1.27  2013/11/08 08:35:13  bihla
 do_encode had a forgotten 'trace' feature - is now removed.

 Revision 1.26  2013/11/08 08:31:40  bihla
 removed ugly print_r($data)

 Revision 1.25  2013/05/02 18:02:54  bihla
 payer_php_0_2_v26 : added 192.168.100.20 in fw rule

 Revision 1.24  2013/03/06 10:41:44  bihla
 added description fo add_freeform_purchase and add_freeform_purchase_ex
...
class payread_post_api {
	...
	function payread_post_api() {
		...
		// Set defaults
		$this->myPostApiVersion   = "payer_php_0_2_v27";
		...
		$this->myFirewall         = array("192.168.100.1","192.168.100.20","79.136.103.5","94.140.57.180","94.140.57.181","94.140.57.184");
	}
	...
	/**
	 * This method must be called at least one call (or add_freeform_purchase_ex)
	 *
	...
	/**
	 * This method must be called at least one call (or add_freeform_purchase)
	 *
	 * This method will add a product, use this method multiple times per each product the buyer will pay for.
	 * @param string $theLineNumber order of the output lines of the products buyed, starting at 1. (required)
	 * @param string $theDescription decription of the product buyed. (required)
	 * @param string $theItemNumber item number. (required)
	 * @param int $thePrice price of the product (each) purchased incl vat. (required)
	 * @param int $theVat vat of the product purchased. [25, 12, 6 or 0] (required)
	 * @param int $theQuantity quantity of the product buyed. (required)
